...
Полиморфизм подтипов: разные объекты классов содержат полностью одинаковые методы
...
Параметрический полиморфизм: один метод (с одним набором параметров соответственно) может обрабатыватьна входе параметры разных типов
